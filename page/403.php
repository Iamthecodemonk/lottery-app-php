...
<body>
    ...
    <div class="container">
        ...
        <p class="error-message">You do not have permission to access this resource. If you believe this is an error, contact the site administrator.</p>

        <div class="action-buttons">
            <a href="/kv/" class="btn-modern">
